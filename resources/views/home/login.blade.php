...
@section('body-content')<div class="container-fluid tm-container-content tm-mt-60">
    <div class="row mb-4 justify-content-around">
        ...
        <div id="logreg-forms">
            <form class="form-signin">
                <h1 class="h3 mb-3 font-weight-normal tm-text-gray" style="text-align: center"> Sign in</h1>
                <div class="social-login d-flex justify-content-around">
                    <button class="btn facebook-btn social-btn" type="button"><span><i class="fab fa-facebook-f"></i> Sign in with Facebook</span> </button>
                    <button class="btn google-btn social-btn" type="button"><span><i class="fab fa-google"></i> Sign
